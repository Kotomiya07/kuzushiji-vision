            ...
            for imgfilepath in glob.glob(os.path.join(bookdir, "*.jpg")):
                ...
                with open(jsonfilepath, "r", encoding="utf-8") as jsonfile_open:
                    ...
                    for index,word in enumerate(jsonfile_load):
                        ...
                        outtext=word["text"]
                        outputimgpath = os.path.join(outputdir, os.path.basename(bookdir), "{}_{}.jpg".format(
                ...
                for imgfilepath in tqdm(glob.glob(os.path.join(bookdir, "*.jpg"))):
                    ...
                    with open(jsonfilepath, "r", encoding="utf-8") as jsonfile_open:
                        ...
                        for index, word in enumerate(jsonfile_load["words"]):
                            ...
                            ymax = max([y0, y1, y2, y3])
                            outtext = word["text"]
                            outputimgpath = os.path.join(outputdir, os.path.basename(projectdir), os.path.basename(bookdir), "{}_{}.jpg".format(
