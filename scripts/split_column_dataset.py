...
def prepare_column_dataset(
    ...
    try:
        ...
        def calculate_column_width(box_str):
            ...
            if isinstance(box_list, list) and len(box_list) == 4:
                ...
                logger.debug(
                    f"Invalid format for box_in_original: {box_str}. Expected list of 4 elements. Marking as invalid width."
                )
        ...
        def calculate_column_height(box_str):
            ...
            if isinstance(box_list, list) and len(box_list) == 4:
                ...
                logger.debug(
                    f"Invalid format for box_in_original: {box_str}. Expected list of 4 elements. Marking as invalid height."
                )
                return -1
    ...
    create_unicode_map(all_unicode_lists)
